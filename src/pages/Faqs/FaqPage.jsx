...
const FaqPage = () => {
  ...
  // const abc = faqData.find((item) => item.section_id === activeTab);

  return (
    <Fragment>
      <SectionHeading heading="Fequently Ask questions" />
